...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
  { label: "Painel", href: "/contabilidade/dashboard" },
  { label: "Empresas", href: "/contabilidade/empresas" },
  { label: "Agendamentos", href: "/contabilidade/agendamentos" },
  { label: "Laudos", href: "/contabilidade/laudos" },
  { label: "Configurações", href: "/contabilidade/settings" }
]
