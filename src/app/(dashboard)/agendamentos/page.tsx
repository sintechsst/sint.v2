        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-zinc-500 dark:text-slate-500 font-medium">
              {role === 'admin'
                ? 'Gerencie todas as solicitações operacionais'
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-zinc-100 dark:divide-white/5 text-sm font-medium">
                  {agendamentos.map((ag) => (
                    <tr key={ag.id} className="group hover:bg-zinc-50 dark:hover:bg-white/[0.02] transition-all">
                      ...
                      <td className="px-8 py-6">
                        <div className="flex flex-col gap-1">
                          ...
                          <span className="text-zinc-700 dark:text-zinc-300 font-bold">{ag.tipo_servico}</span>
                        </div>
                      </td>

                      <td className="px-8 py-6">
                        <div className="flex flex-col gap-1">
                          <span className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Especialista</span>
